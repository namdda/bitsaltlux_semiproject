			...
			<div class="main-content">
				<div class="container" style="text-align: center;">
					<div class="card card-body">
						...
						<form id="add" name="add" method="post" action="/blog/${id }/post/${no }/updateProc.do" enctype="multipart/form-data">
							<fieldset>
								<div class="form-group">
									<input id="input-title" class="form-control input-lg" placeholder="제목" name="title" type="text" value="${postVo.title }">
								</div>
								<br/>
								<div class="form-group">
								...
								<br/>
								<input class="form-control input-lg" placeholder="아이디" name="blogId" value="${postVo.blogId }" type="hidden">
								<div class="form-group">
