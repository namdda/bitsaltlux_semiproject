			...
			<div class="main-content">
				<div class="container-fluid bg-light py-3">
					<div class="col-md-6 col-md-offset-3">
						...
						<form id="join" name="join" method="post" action="/blog/${id }/joinProc.do" enctype="multipart/form-data">
							<fieldset>
								<div class="form-group">
									<input class="form-control input-lg" placeholder="아이디" name="userId" type="hidden" value="${id }">
									<input class="form-control input-lg" placeholder="닉네임" name="userName" type="text" value="${sessionScope.userNm }" readonly="readonly">
								</div>
								<br/>
								<div class="form-group">
