						...
						<div class="col-md-6 mx-auto">
							<div class="card card-body">
								...
								<form id="join" name="join" method="post"
									action="/blog/${sessionScope.userId }/joinBlog.do"
									enctype="multipart/form-data">
									<fieldset>
										<div class="form-group">
											<input class="form-control input-lg" placeholder="아이디"
												name="user_id" type="text" value="${sessionScope.userId}"
												readonly="readonly">
										</div>
										<br />
										<div class="form-group">
											<input id="input-title" class="form-control input-lg"
												placeholder="블로그 제목" name="title" type="text">
										</div>
										<br />
										<div class="form-group">
											<input id="b_file_up" class="form-control input-lg"
												placeholder="블로그 로고" name="file" type="file">
										</div>
										<br />
										<div class="form-group">
											<textarea class="form-control input-lg" placeholder="블로그 소개"
												name="intro" rows="5" cols="86" style="resize: none;"></textarea>
										</div>
										<br /> <input id="btn-submit"
											class="btn btn-lg btn-primary btn-block" value="입력 완료"
											type="submit">
									</fieldset>
								</form>
							</div>
